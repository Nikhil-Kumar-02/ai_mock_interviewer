...
//       // Start analyzing every 50ms
//       intervalIdRef.current = setInterval(analyzeVolume, 50);
//     } catch (err) {
//       console.error("Error accessing microphone:", err);
...
//   // Provide feedback and determine building heights based on volume
//   useEffect(() => {
//     if (isRecording) {
//       if (volume > 150) {
//         setFeedback("Your voice is quite loud! Try to moderate your tone.");
//       } else if (volume > 80) {
//         setFeedback("You're speaking at a perfect volume.");
//       } else if (volume > 20) {
//         setFeedback("Your voice is soft. Try speaking a bit louder.");
//       } else {
//         setFeedback("We can barely hear you. Please speak up.");
//       }
//     } else {
//       setFeedback("");
//     }
...
//   // Calculate building heights based on volume
//   const calculateBuildingHeight = (index) => {
//     if (!isRecording || volume === 0) return 20; // Default height when not recording
    
//     // Create different heights based on voice intensity and building index
//     const baseHeight = Math.min(Math.max(volume * 0.5, 20), 100);
    
//     // Make different buildings have varying heights
//     switch (index) {
//       case 0: return baseHeight * 0.8;
//       case 1: return baseHeight * 1.0;
//       case 2: return baseHeight * 1.2;
//       case 3: return baseHeight * 0.9;
//       case 4: return baseHeight * 1.1;
...
//       {/* Voice intensity visualization (buildings) */}
//       <div className="my-4 flex items-end justify-center gap-2 h-32">
//         {[0, 1, 2, 3, 4].map((index) => (
//           <div 
//             key={index}
//             style={{ 
//               height: `${calculateBuildingHeight(index)}px`,
